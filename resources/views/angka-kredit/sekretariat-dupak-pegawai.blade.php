            ...
            <div class="col-md-12">
              ...
              <div id="table">
                ...
                <form id="intersect" method="post">
                  ...
                  <input type="text" id="id_date_noIntersect" name="noIntersect[]" hidden>

                  <button type="submit" class="btn btn-success">Lihat Status SP</button>
                </form>
              </div>
            </div>
          </div>
...
<script>
  ...
  $(document).ready(() => {
    ...
    $.get('{{url("")}}/angka-kredit/sekretariat-dupak/get-match-date/' + id_pegawai, (res) => {
      ...
      $.each(res, (idx, val) => {
        id_all_dates.push(res[idx].id)
      })
      
      id_noIntersect = id_all_dates.filter(function(obj) { return id_intersect.indexOf(obj) == -1; });
      ...
      $('#id_date_noIntersect').attr('value', id_noIntersect)
