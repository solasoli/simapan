...
<div class="tim" data-id='0' data-idx='{{ $tagIdx }}'>
    ...
    <div class="card-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <select name='inspektur_pembantu' class="form-control select2 inspektur_pembantu must-unique" data-selected='{{ isset($data->id) ? $data->id_inspektur_pembantu : 0 }}'>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <select name='pengendali_teknis' class="form-control select2 pengendali_teknis must-unique"  data-selected='{{ isset($data->id) ? $data->id_pengendali_teknis : 0 }}'>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <select name='ketua_tim' class="form-control select2 ketua_tim must-unique"  data-selected='{{ isset($data->id) ? $data->id_ketua_tim : 0 }}'>
                    [option_ketua_tim]
                </select>
            </div>
        </div>
