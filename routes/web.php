...
Route::middleware(['auth'])->group(function () {
  ...
  Route::prefix('pkpt')->group(function () {
    ...
    Route::prefix('surat_perintah')->group(function () {
      ...
      Route::get('/kalendar-kerja', 'Pkpt\SuratPerintahController@kalendar_kerja');
      Route::post('/kalendar', 'Pkpt\SuratPerintahController@kalendar');
  ...
  Route::prefix('angka-kredit')->group(function () {
    ...
    Route::get('/table-auditor-angka-kredit/edit/{id}', 'AngkaKredit\EditAngkaKredit@edit');
    Route::get('/table-auditor-angka-kredit/list_data_editTables/{id}', 'AngkaKredit\EditAngkaKredit@list_data_editTables');
    Route::get('/table-auditor-angka-kredit/form_edit/{id}', 'AngkaKredit\EditAngkaKredit@form_edit');
    Route::get('/table-auditor-angka-kredit/update/{id}', 'AngkaKredit\EditAngkaKredit@update');
    ...
    Route::post('/edit-angka-kredit/update/{id}', 'AngkaKredit\EditAngkaKredit@update');

    Route::get('/get_angkaKredit/{id_sp}', 'AngkaKredit\EditAngkaKredit@angkaKredit');

    Route::prefix('sekretariat-dupak')->group(function () {
      Route::get('/', 'AngkaKredit\SekretariatDupak@index');
      Route::get('/get-pegawai-Jabatan', 'AngkaKredit\SekretariatDupak@getPegawaiJabatan');
      Route::get('/surat-perintah-pegawai/{id}', 'AngkaKredit\SekretariatDupak@suratPerintahPegawai');

      Route::get('/surat-perintah-pegawai/get-info-sp/{id}', 'AngkaKredit\TimPenilai@getInfoPegawai');

      Route::get('/get-match-date/{id}', 'AngkaKredit\SekretariatDupak@getMatchDate');
      Route::get('/get-match-date-status', 'AngkaKredit\SekretariatDupak@getMatchDateStatus');

      Route::get('/status-tanggal-sp', 'AngkaKredit\SekretariatDupak@status_tanggal_sp');
      Route::get('/statusTanggalSp/{date}', 'AngkaKredit\SekretariatDupak@getStatusTanggalSp');

      Route::get('/edit-status-tanggal-sp/{id}', 'AngkaKredit\SekretariatDupak@update');
    });

    Route::prefix('status-sp')->group(function() {
      Route::get('/get-pegawai', 'AngkaKredit\StatusSp@getPegawai');
      Route::get('/{status}/{id}', 'AngkaKredit\StatusSp@getStatusSuratPerintah');
      Route::get('/pegawai', 'AngkaKredit\StatusSp@getIntersectStatus');
      Route::get('/status-sp-pegawai/{status}/{id}', 'AngkaKredit\StatusSp@status_sp_pegawai');
    });

    Route::post('/sekretariat-dupak-beririsan', 'AngkaKredit\SekretariatDupak@get_date_intersect');

    Route::post('/sekretariat-dupak/status-sp/{id}', 'AngkaKredit\SekretariatDupak@statusSp');

    Route::get('/review-sekretariat-dupak/{id}', 'AngkaKredit\ReviewSekretariatDupak@index');
    ...
    Route::get('/sp-pegawai/{id}', 'AngkaKredit\TimPenilai@sp_pegawai');
    Route::get('/getSpPegawai/{id}', 'AngkaKredit\TimPenilai@getSpPegawai');

    Route::get('/review-tim-penilai/{id}', 'AngkaKredit\ReviewTimPenilai@index');
